    ...
    <div className="detail-container">
      <div className="detail-header">
        ...
        <div className="header-actions">
          <button className="btn-edit" onClick={() => navigate(`/marketing/google/editar/${id}`)}>
            <FiEdit2 /> Editar
          </button>
      ...
      <div className="detail-content">
        ...
        <div className="detail-grid">
          ...
          <div className="detail-section">
            <h2>Faturamento</h2>
            <div className="detail-row">
              <span className="label">Vendas Google:</span>
              <span className="value">{formatCurrency(data.vendas_google)}</span>
            </div>
            <div className="detail-row">
