...
const WeeklyDashboard = ({ dashboardData, customization }) => {
  ...
  const renderMetricCard = (icon, title, value, average, prefix = '', isPercentage = false) => {
    ...
    const showComparative = numAverage !== 0 && numAverage !== null && !isNaN(numAverage);
                    ...
                    <BarChartComponent
                      ...
                      datasets={[
                        ...
                        },
                        {
                          ...
                          data: dashboardData?.labels.map(() => dashboardData?.vendas_google_avg || 0),
                          borderColor: '#9CA3AF',
                          borderDash: [5, 5]
                        }
                      ]}
