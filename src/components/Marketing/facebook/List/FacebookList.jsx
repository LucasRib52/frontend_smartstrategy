...
import '../../../Marketing/google/List/GoogleList.css';
...
const FacebookList = () => {
  ...
  useEffect(() => {
    const filtered = data.filter(item => Number(item.vendas_facebook) > 0);
    ...
    <div className="google-list">
      <div className="dashboard-header">
        <div className="header-title">
          ...
          <p className="subtitle">Acompanhamento de Campanhas Facebook</p>
        </div>
        ...
        <div className="header-actions">
          ...
          <button className="btn-new" onClick={() => navigate('/marketing/facebook/novo')}>
                ...
                <tbody>
                  {currentData.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td data-type="currency">{item.vendas_facebook ? formatCurrency(item.vendas_facebook) : '-'}</td>
                      ...
                      <td>
                        <div className="action-buttons">
                          <button 
                            ...
                            onClick={() => navigate(`/marketing/facebook/detalhe/${item.id}`)}
                          >
                            <FiEye />
                          </button>
                          <button 
                            ...
                            onClick={() => navigate(`/marketing/facebook/editar/${item.id}`)}
                          >
                            <FiEdit2 />
                          </button>
                          <button 
                            ...
                            onClick={() => navigate(`/marketing/facebook/excluir/${item.id}`)}
                          >
                            <FiTrash2 />
                          </button>
                        </div>
