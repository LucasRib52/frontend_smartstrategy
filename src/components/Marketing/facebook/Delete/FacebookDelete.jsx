      ...
      <div className="delete-content">
        ...
        <div className="delete-details">
          ...
          <div className="detail-grid">
            ...
            <div className="detail-section">
              <h3>Faturamento</h3>
              <div className="detail-row">
                <span className="label">Vendas Facebook:</span>
                <span className="value currency">
                  {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(data.vendas_facebook)}
                </span>
              </div>
              <div className="detail-row">
        ...
        <div className="delete-actions">
          <button 
            ...
            onClick={() => navigate('/marketing/facebook')}
          >
            Cancelar
          </button>
          <button 
