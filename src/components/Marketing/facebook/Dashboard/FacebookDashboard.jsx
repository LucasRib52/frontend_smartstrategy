...
const FacebookDashboard = () => {
  ...
  const [customization, setCustomization] = useState({
    cards: {
      ...
      vendas_facebook: { visible: true, order: 5 },
    ...
    charts: {
      ...
      vendas_facebook: { visible: true, order: 8 },
      taxa_conversao: { visible: true, order: 9 },
      cac: { visible: true, order: 10 }
    }
  });
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log('Buscando dados do Facebook com filtros:', { ...filters, plataforma: 'facebook' });
      const data = await vendaService.getDashboardData({ ...filters, plataforma: 'facebook' });
      console.log('Dados recebidos do Facebook:', data);
      ...
      console.log('Buscando dados históricos do Facebook:', historicalFilters);
      const historicalData = await vendaService.getDashboardData(historicalFilters);
      console.log('Dados históricos recebidos do Facebook:', historicalData);
