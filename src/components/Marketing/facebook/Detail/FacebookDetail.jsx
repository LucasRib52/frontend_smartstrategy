    ...
    <div className="detail-container">
      <div className="detail-header">
        ...
        <div className="header-actions">
          <button className="btn-edit" onClick={() => navigate(`/marketing/facebook/editar/${id}`)}>
            <FiEdit2 /> Editar
          </button>
      ...
      <div className="detail-content">
        ...
        <div className="detail-grid">
          ...
          <div className="detail-section">
            <h2>Faturamento</h2>
            <div className="detail-row">
              <span className="label">Vendas Facebook/Meta:</span>
              <span className="value">{formatCurrency(data.vendas_facebook_meta)}</span>
            </div>
            <div className="detail-row">
