...
const InstagramForm = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setFormData({
        ...response,
        vendas_instagram: response.vendas_instagram || '',
  ...
  const handleChange = (e) => {
    ...
    setFormData(prev => {
      ...
      // Extrair data para cálculos temporais
      if (name === 'data' && value) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSubmit = {
        data: formData.data,
        invest_realizado: formData.invest_realizado,
        invest_projetado: formData.invest_projetado,
        vendas_instagram: formData.vendas_instagram,
        fat_proj: formData.fat_proj,
        fat_camp_realizado: formData.fat_camp_realizado,
        fat_geral: formData.fat_geral,
        ticket_medio_realizado: formData.ticket_medio_realizado,
        leads: formData.leads,
        clientes_novos: formData.clientes_novos,
        clientes_recorrentes: formData.clientes_recorrentes,
        conversoes: formData.conversoes
      };
        ...
        <div className="form-content">
          <div className="input-section">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                <label htmlFor="vendas_instagram">
                  <FiBarChart2 className="field-icon" /> Vendas Instagram (R$)
                </label>
                <input
                  type="number"
                  name="vendas_instagram"
                  id="vendas_instagram"
                  value={formData.vendas_instagram}
                  onChange={handleChange}
                  step="0.01"
                  min="0"
                  required
